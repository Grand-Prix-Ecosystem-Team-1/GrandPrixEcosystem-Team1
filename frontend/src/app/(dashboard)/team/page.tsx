...
export default async function TeamPage() {
  ...
  <main className="min-h-full bg-[#F0F4F8] px-10 py-8">
    {teamMembersData.length === 0 ? (
      <div className="flex min-h-[calc(100vh-128px)] flex-col items-center justify-center text-[#102a43]">
        <Users
            className="mb-5 h-16 w-16 text-[#486581]"
            strokeWidth={1.5}
            />
      ...
      <div className="flex min-h-[calc(100vh-128px)] flex-col text-[#102a43]">
        ...
        <div className="ml-[90px] mr-[90px] grid grid-cols-1 justify-items-center gap-[24px] sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
